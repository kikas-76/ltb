...
class _ListingsPageWidgetState extends State<ListingsPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().tempStartDate =
          DateTime.fromMillisecondsSinceEpoch(946681200000);
      FFAppState().tempEndDate =
          DateTime.fromMillisecondsSinceEpoch(946681200000);
      FFAppState().datesSelected = false;
      safeSetState(() {});
      await Future.wait([
        Future(() async {
          _model.isFavorited =
              (currentUserDocument?.savedListings.toList() ?? [])
                  .contains(widget.listingsRef);
          safeSetState(() {});
        }),
        Future(() async {
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    Builder(
                                      builder: (context) {
                                        final pageViewPhotosUrlItem =
                                            listingsPageListingsRecord.photosUrl
                                                .toList();
                                                ...
                                                controller: _model
                                                    ...
                                                    PageController(
                                                        initialPage: max(
                                                            ...
                                                            min(
                                                                0,
                                                                pageViewPhotosUrlItem
                                                                        .length -
                                                                    1))),
                                                scrollDirection:
                                                    Axis.horizontal,
                                                itemCount: pageViewPhotosUrlItem
                                                    .length,
                                                itemBuilder: (context,
                                                    pageViewPhotosUrlItemIndex) {
                                                  final pageViewPhotosUrlItemItem =
                                                      pageViewPhotosUrlItem[
                                                          pageViewPhotosUrlItemIndex];
                                                  return Column(
                                                    mainAxisSize:
                                                              ...
                                                              child:
                                                                ...
                                                                image:
                                                                  ...
                                                                  imageUrl:
                                                                      valueOrDefault<
                                                                          String>(
                                                                    pageViewPhotosUrlItemItem,
                                                                    'https://img.freepik.com/vecteurs-premium/signe-reglage-du-contour-icone-image_1223784-6095.jpg',
                                                                  ),
                                                                  fit: BoxFit
                                                                      .contain,
                                                                ),
                                    ...
                                    Align(
                                      alignment:
                                          AlignmentDirectional(0.91, -0.88),
                                      child: ToggleIcon(
                                        onPressed: () async {
                                          safeSetState(() =>
                                              _model.isFavorited =
                                                  !_model.isFavorited);
                                          if (_model.isFavorited == true) {
                            ...
                            Padding(
                              ...
                              child: FutureBuilder<CategoriesRecord>(
                                future: CategoriesRecord.getDocumentOnce(
                                    listingsPageListingsRecord.categoryRef!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                  ...
                                  return InkWell(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          decoration: BoxDecoration(
                                            color: rowCategoriesRecord.color,
                                            borderRadius:
                            ...
                            Align(
                              alignment: AlignmentDirectional(-1.04, 0.98),
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    12.0, 0.0, 0.0, 8.0),
                                child: Text(
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (FFAppState().datesSelected == false)
                                    Align(
                            ...
                            if (FFAppState().datesSelected == true)
                              Align(
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: InkWell(
                                  splashColor: Colors.transparent,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '${functions.formatDateFr(FFAppState().tempStartDate!)}→ ${functions.formatDateFr(FFAppState().tempEndDate!)}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .titleSmall
                                                      .override(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  '${listingsPageListingsRecord.price.toString()}€',
                                                  style:
                                                      FlutterFlowTheme.of(
                                                              context)
                                                          .titleSmall
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '${listingsPageListingsRecord.depositAmount.toString()}€',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .titleMedium
                                                      .override(
                                      ...
                                      Align(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Pas de caution pour cette annonce',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .labelLarge
                                                  .override(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
                                              if (functions.calculatePriceBeforeDiscount(
                                                          FFAppState()
                                                              .tempStartDate,
                                                          FFAppState()
                                                              .tempEndDate,
                                                          listingsPageListingsRecord
                                                              .price) !=
                                                      null &&
                                                  functions.calculatePriceBeforeDiscount(
                                                          FFAppState()
                                                              .tempStartDate,
                                                          FFAppState()
                                                              .tempEndDate,
                            ...
                            if (functions.getDiscountLabel(
                                        FFAppState().tempStartDate,
                                        FFAppState().tempEndDate) !=
                                    null &&
                                functions.getDiscountLabel(
                                        FFAppState().tempStartDate,
                                        FFAppState().tempEndDate) !=
                                    '')
                              Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding: EdgeInsets.all(5.0),
                                            child: Text(
                                              '${functions.getDiscountLabel(FFAppState().tempStartDate, FFAppState().tempEndDate)}',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyLarge
                                                  .override(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    OwnerProfilePageWidget.routeName,
                                    queryParameters: {
                                      'ownerRef': serializeParam(
                                        listingsPageListingsRecord.ownerRef,
                                        ParamType.DocumentReference,
                                      ),
                                    }.withoutNulls,
                                  );
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          await launchURL(
                                              'https://maps.google.com/?q=${listingsPageListingsRecord.locationData.location?.toString()}');
                                        },
                                        child: AutoSizeText(
                                          '${listingsPageListingsRecord.locationData.city}',
                                          maxLines: 2,
                                          minFontSize: 14.0,
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: EdgeInsets.all(8.0),
                                              child: Text(
                                                'Cette position est approximative',
                        ...
                        child: Container(
                          ...
                          child: Align(
                            ...
                            child: Row(
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceAround,
                              children: [
                                if (_model.existingBooking ? false : true)
                                  Text(
                                    '${valueOrDefault<String>(
                                      functions.calculateTotalPrice(
                                          FFAppState().tempStartDate!,
                                ...
                                if (listingsPageListingsRecord.ownerRef !=
