          ...
          child: Scaffold(
            ...
            body: Stack(
              children: [
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(16.0, 12.0, 16.0, 90.0),
                  child: Column(
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.asset(
                                          'assets/images/Banniere_LTB-11.png',
                                          fit: BoxFit.contain,
                                    ...
                                    Align(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.asset(
                                          'assets/images/Banniere_LTB-9.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    Align(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.asset(
                                          'assets/images/Banniere_LTB-10.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
