...
import 'create_listingprix4_model.dart';
export 'create_listingprix4_model.dart';

class CreateListingprix4Widget extends StatefulWidget {
  ...
  @override
  State<CreateListingprix4Widget> createState() =>
      _CreateListingprix4WidgetState();
}

class _CreateListingprix4WidgetState extends State<CreateListingprix4Widget> {
  late CreateListingprix4Model _model;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ListingsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final createListingprix4ListingsRecord = snapshot.data!;

        return Title(
            title: 'CreateListingprix4',
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Déterminez le prix et vérifiez votre annonce',
                              style: FlutterFlowTheme.of(context)
                                  .bodyLarge
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                alignLabelWithHint: false,
                                                hintText:
                                                    'Ex: 50 ou écrire 0 si pas de caution',
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 5.0,
                                                                5.0, 5.0),
                                                    child: Text(
                                                      'La caution recommandée est généralement \nentre 30% et 50% de la valeur de l\'objet',
                                                      textAlign:
                                                          TextAlign.center,
                                                        ...
                                                        child: ClipRRect(
                                                          ...
                                                          child:
                                                            ...
                                                            imageUrl:
                                                                valueOrDefault<
                                                                    String>(
                                                              createListingprix4ListingsRecord
                                                                  .photosUrl
                                                                  .firstOrNull,
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          if (createListingprix4ListingsRecord
                                                                  .categoryRef !=
                                                              null)
                                                            StreamBuilder<
                                                                CategoriesRecord>(
                                                          ...
                                                          if (_model.textField1TextController
                                                                  ...
                                                                  '')
                                                            Text(
                                                              '${_model.pricePerDay?.toString()} € / jour',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .titleMedium
                                                                  .override(
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 2.0, 0.0, 2.0),
                                                  child: Text(
                                                    'Réductions automatiques selon la durée de location',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelSmall
                                                        .override(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    _model.deposit! > 0.0
                                                        ? 'Caution : ${_model.deposit.toString()} €'
                                                          ...
                                                          child: Padding(
                                                            padding:
                                                                EdgeInsets.all(
                                                                    5.0),
                                                            child: Text(
                                                              'Vos revenus potentiels après déduction des \nfrais de service',
                                                              textAlign:
                                                                  TextAlign
                                                                      .center,
                                                              style: FlutterFlowTheme
