...
import '/components/edit_booking_component_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BookingsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final conversationPageBookingsRecord = snapshot.data!;
                            ...
                            Expanded(
                              child: StreamBuilder<ListingsRecord>(
                                stream: ListingsRecord.getDocument(
                                    conversationPageBookingsRecord.listingRef!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                  ...
                                  final rowListingsRecord = snapshot.data!;
                                  ...
                                  return Row(
                                    ...
                                    children: [
                                      ...
                                      if (conversationPageBookingsRecord
                                              .renterRef ==
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, listViewIndex) {
                                  ...
                                  return StreamBuilder<UsersRecord>(
                                    stream: UsersRecord.getDocument(
                                        listViewMessagesRecord.userRef!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                            ...
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                await MessagesRecord.createDoc(
                                  ...
                                  text: _model.messageFieldTextController.text,
