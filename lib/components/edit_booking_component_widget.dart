                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.tempStartDate = _model.datePicked1;
                                safeSetState(() {});
                              ...
                              text: valueOrDefault<String>(
                                dateTimeFormat("d/M", _model.tempStartDate),
                                '0',
                              ),
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.tempEndDate = _model.datePicked2;
                                safeSetState(() {});
                                _model.tempTotalPrice =
                                    ((functions.calculateDaysBetween(
                                                _model.tempStartDate!,
                              ...
                              text: valueOrDefault<String>(
                                dateTimeFormat("d/M", _model.tempEndDate),
                                '0',
                              ),
                              options: FFButtonOptions(
                                width: 120.0,
