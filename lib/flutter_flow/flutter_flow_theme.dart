...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFAEDCD);
  late Color tertiary = const Color(0xFFD4A373);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF0E0D0D);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFEFAE0);
  late Color secondaryBackground = const Color(0xFFFEFAE0);
  late Color accent1 = const Color(0xFFE9EDC9);
  late Color accent2 = const Color(0xFFE9EDC9);
