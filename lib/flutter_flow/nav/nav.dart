...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CategorieWidget.routeName,
          path: CategorieWidget.routePath,
          builder: (context, params) => CategorieWidget(
            categorieRef: params.getParam(
              'categorieRef',
        ...
        FFRoute(
          name: ObjetsprsdechezvousPageWidget.routeName,
          path: ObjetsprsdechezvousPageWidget.routePath,
          builder: (context, params) => ObjetsprsdechezvousPageWidget(
            categorieName: params.getParam(
              'categorieName',
              ParamType.String,
            ),
            categorieValue: params.getParam(
              'categorieValue',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          path: CompleteYourProfilWidget.routePath,
          builder: (context, params) => CompleteYourProfilWidget(),
        ),
        FFRoute(
          name: AdressPageWidget.routeName,
          path: AdressPageWidget.routePath,
