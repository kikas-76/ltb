  ...
  Widget build(BuildContext context) {
    return Title(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            key: scaffoldKey,
            backgroundColor: FlutterFlowTheme.of(context).cornsilk,
            body: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Align(
                    alignment: AlignmentDirectional(-1.06, 0.4),
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(24.0, 50.0, 0.0, 16.0),
                      child: Container(
                        width: 90.0,
                        height: 90.0,
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: functions
                                .memberSince(currentUserDocument?.createdTime),
                            style: TextStyle(),
                          )
                        ],
                        style:
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed(
                          SettingsProfileWidget.routeName,
