...
class _BookingCalendarState extends State<BookingCalendar> {
  ...
  void _writeToAppState(DateTime? start, DateTime? end) {
    // On stocke des dates "jour" (00:00) pour éviter les bugs d’heures
    final s = start == null ? null : _dateOnly(start);
    final e = end == null ? null : _dateOnly(end);

    // FlutterFlow App State update
    FFAppState().update(() {
          ...
          child: SfDateRangePicker(
            ...
            onSelectionChanged: (DateRangePickerSelectionChangedArgs args) {
              ...
              if (value is PickerDateRange) {
                ...
                // ✅ startDate existe dès le 1er clic
                final start = value.startDate;
                // ✅ endDate n’existe qu’après le 2e clic (fin de plage)
                final end = value.endDate;

                // ✅ Stocke dans App State
