                ...
                children: [
                  ...
                  Align(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        await launchURL(
                            'https://www.linkedin.com/company/louetonbien/');
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/linkedin-logo-linkedin-icon-transparent-free-png-2.webp',
                          width: 70.0,
                          height: 70.0,
                          fit: BoxFit.cover,
                        ),
                  ...
                  Align(
                    alignment: AlignmentDirectional(0.44, 0.95),
                    child: InkWell(
                      splashColor: Colors.transparent,
                      focusColor: Colors.transparent,
                      hoverColor: Colors.transparent,
                      ...
                      onTap: () async {
                        await launchURL(
                            'https://www.instagram.com/louetonbien.fr?igsh=MXY2aGQ0czNyczlzMQ==');
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                  ...
                  Align(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        await launchURL('https://www.tiktok.com/@louetonbien');
                      },
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/tiktok-logo-tiktok-social-media-icon-free-png.png',
                          width: 65.0,
                          height: 65.0,
                          fit: BoxFit.cover,
                        ),
