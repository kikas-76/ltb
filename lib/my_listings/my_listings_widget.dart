  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ListingsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ListingsRecord> myListingsListingsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final myListingsListingsRecord = myListingsListingsRecordList.isNotEmpty
            ? myListingsListingsRecordList.first
            : null;
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  ...
                                  options: FFButtonOptions(
                                    ...
                                    elevation: 0.0,
                                    borderRadius: BorderRadius.circular(8.0),
                                    hoverColor: _model.currentTab == 'stock'
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  ...
                                  options: FFButtonOptions(
                                    ...
                                    elevation: 0.0,
                                    borderRadius: BorderRadius.circular(8.0),
                                    hoverColor: _model.currentTab == 'activite'
                                        ? FlutterFlowTheme.of(context).primary
                                        : FlutterFlowTheme.of(context)
                                            .secondary,
                                    hoverTextColor: FlutterFlowTheme.of(context)
                                                                        ...
                                                                        children: [
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              '${dateTimeFormat(
                                                                                "d/M",
                                                                                listViewBookingsRecord.startDate,
                                                                                locale: FFLocalizations.of(context).languageCode,
                                                                              )} au ${dateTimeFormat(
                                                                                "d/M/y",
                                                                                listViewBookingsRecord.endDate,
                                                                                locale: FFLocalizations.of(context).languageCode,
                                                                              )}',
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              stream: UsersRecord.getDocument(listViewListingsRecord.ownerRef!),
                                                                              builder: (context, snapshot) {
                                                                                // Customize what your widget looks like when it's loading.
                                                                                if (!snapshot.hasData) {
                                                                                  return Center(
                                                                                ...
                                                                                return Text(
                                                                                  '${textUsersRecord.displayName} - ${listViewBookingsRecord.totalPrice.toString()}€',
